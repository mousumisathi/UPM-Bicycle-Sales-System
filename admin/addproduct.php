...
mysqli_query($connect,"INSERT INTO 'products' (product_id, product_cat, product_brand,product_title,product_price, product_desc, product_image,product_keywords) VALUES ('$product_id','$product_type','$brand','$product_name','$price','$details','$pic_name','$tags')") ;
...
?>
      ...
      <div class="content">
        <div class="container-fluid">
          <form action="sumit_form.php" method="post" type="form" name="form" enctype="multipart/form-data">
          <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="product_name" action="sumit_form" required name="product_name" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="">
