...
<meta charset="utf-8">
    ...
    <title>UPM Bicycle Sales System|Home</title>
...
<body style="background: #fff;">
                        ...
                        <div class="header-logo">
                            <a href="index.php" class="logo">
                                <font style="font-style:normal; font-size: 33px;color: aliceblue;font-family: serif">
                                    <img src="./img/download.png" style="width: 150px;">
                                </font>
                               ...
                               <div class="dropdownn">
                                ...
                                <a href="#" class="dropdown-toggle" ><i class="fa fa-user-o"></i> </a>
                                  ...
                                  <a href="login_form.php"  ><i class="fa fa-sign-in" aria-hidden="true"></i>Login</a>
                                    <a href="register_form.php"  ><i class="fa fa-user-plus" aria-hidden="true"></i>Sign up</a>
    ...
    margin-right: 15px;
                          ...
                          <li><a href="chat.php"><i class="fa fa-comment" aria-hidden="true"></i></a></li>
